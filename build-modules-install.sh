...
make ARCH=arm CROSS_COMPILE=~/Android/CM7.2/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi- INSTALL_MOD_PATH=~/Android/Kernels/MS910-modules modules modules_install -j4
#
